...
{/if}
	...
	<body>
		<div id="maintenance">
			 <p><img src="{$base_dir}/themes/mononduleur_2013/img/logo_mononduleur.png" {if $logo_image_width}width="{$logo_image_width}"{/if} {if $logo_image_height}height="{$logo_image_height}"{/if} alt="logo" /><br /><br /></p>
			 <p id="message">
