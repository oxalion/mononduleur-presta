...
{else}
	<a href="{$link->getPageLink('history', true)}" title="{l s='Back to orders'}">
		<i class="icon-2x icon-fixed-width icon-no-decoration icon-shoppingcartalt"></i>
	{l s='Back to orders'}</a>
{/if}
