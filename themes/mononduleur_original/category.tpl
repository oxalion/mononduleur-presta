...
{if $category->id AND $category->active}
	...
	{if $products}
		...
		{elseif !isset($subcategories)}
			<p class="warning">Afin de r&eacute;pondre au mieux &agrave; votre demande, notre &eacute;quipe se tient &agrave; votre disposition. <a href="contact-form.php">Nous contacter</a>.<!--{l s='There are no products in this category.'}--></p>
		{/if}
{elseif $category->id}
